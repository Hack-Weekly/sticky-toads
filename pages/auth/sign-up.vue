<template>
  <section class="py-24 lg:pb-32 md:overflow-hidden h-screen">
    <div class="container px-4 mx-auto space-y-3">
      <div
        class="relative bg-gray-800 px-6 pt-10 pb-8 shadow-xl border-2 border-gray-700 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10"
      >
        <div class="mx-auto max-w-xl">
          <div class="divide-y divide-gray-700/50">
            <h1 class="text-3xl font-bold text-center text-gray-100 pb-3">
              Create an account
            </h1>
            <div class="pt-8 text-base font-semibold leading-7">
              <form @submit.prevent="onSubmit">
                ...
                <div
                  class="flex flex-col md:flex-row items-center justify-between pt-5 gap-3 md:gap-0"
                >
                  <div class="flex items-center">
                    ...
                    <NuxtLink
                      to="/auth/sign-in"
                      class="ml-1 text-sm font-bold text-cyan-400 hover:text-cyan-600 transition-colors ease-in-out duration-150"
                    >
                      Sign In
                    </NuxtLink>
                  </div>
